...
def night_vision():
    ...
    while True:
        ...
        if (
            ...
            night_vision = cv.merge([
                dark_gray,                    # Blue
                np.clip(dark_gray + 40, 0, 255),  # Green boosted
                dark_gray                     # Red
            ])
            ...
            cv.circle(overlay, (0, 0), 250, (0, 255, 0), -1)
            cv.circle(overlay, (w, 0), 250, (0, 255, 0), -1)
            cv.circle(overlay, (0, h), 250, (0, 255, 0), -1)
            cv.circle(overlay, (w, h), 250, (0, 255, 0), -1)

            overlay = cv.GaussianBlur(overlay, (151, 151), 0)

            night_vision = cv.addWeighted(
                night_vision,
                1.0,
                overlay,
                0.25,
